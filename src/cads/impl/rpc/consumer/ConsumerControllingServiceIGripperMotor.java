...
public class ConsumerControllingServiceIGripperMotor implements IGripperMotor {
	
	protected MarshallingService marshallingService;
	protected Buffer<String> senderBuffer;
	
	public ConsumerControllingServiceIGripperMotor(int brokerPort, String brokerIp) throws InstantiationException, IllegalAccessException, SocketException, UnknownHostException {
...
public void grab(boolean toClose) {
    putMessageToBuffer(new ServiceMessage(new ServiceFunction("grab", Arrays.asList(new ServiceFunctionParameter("boolean", "toClose", String.valueOf(toClose))), "void")));
}
