...
public class ConsumerControllingServiceIVertikalMotor implements IVertikalMotor {
	
	protected MarshallingService marshallingService;
	protected Buffer<String> senderBuffer;
	
	public ConsumerControllingServiceIVertikalMotor(int brokerPort, String brokerIp) throws InstantiationException, IllegalAccessException, SocketException, UnknownHostException {
