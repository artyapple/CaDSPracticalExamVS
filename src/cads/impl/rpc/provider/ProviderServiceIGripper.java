...
import cads.impl.hal.IGripper;

public class ProviderServiceIGripper implements Runnable {
	...
	public void run() {
		try {
			...
			service = fac.getInstance(IGripper.class);
...
break;
					default:
						System.out.println("ProviderServiceIGripper: " + "can not handle " + function.getName() + " function");
						break;
				}
